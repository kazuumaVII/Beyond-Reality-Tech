...
export const dataCarouselBuild: ItemInfoProps[] = [
  {
    index: 0,
    title: 'Simulation',
    description:
...
export const dataSocialMedia = [
  ...
  {
    pathImg: './assets/twitter.svg'
  },
  {
    pathImg: './assets/youtube.svg'
  },
  {
    pathImg: './assets/linkedin.svg'
  },
  {
    pathImg: './assets/pinterest.svg'
  }
];
